...
1. **GitHub Security Advisory (preferred).**
   [Open a private advisory](https://github.com/synheart-ai/synheart-session-flutter/security/advisories/new).
...
This policy covers the `synheart_session` Flutter SDK published from this
